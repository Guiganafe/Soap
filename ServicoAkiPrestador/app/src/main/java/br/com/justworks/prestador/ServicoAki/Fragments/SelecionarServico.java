...
public class SelecionarServico extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_selecionar_servico, container, false);
    }
    ...
    private void onClickController() {
        adapter.setOnItemClickListener(new ServicesItemAdapter.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot, int position, View v) {
                ...
                Navigation.findNavController(v).navigate(R.id.action_selecionarServico_to_configurarServicos);
            }
        });
    }
    ...
    private void inicializarComponentes(View view) {
        recyclerView = view.findViewById(R.id.reciclerView_SelecionarServico);
    }
}