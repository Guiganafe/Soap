...
public class HorizontalPickerAdapter extends RecyclerView.Adapter<HorizontalPickerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(item.isSelected())
        {
            ...
            holder.tvWeekDay.setBackgroundDrawable(getDateSelectedBackground(holder.itemView));
            holder.tvWeekDay.setTextColor(mDateSelectedTextColor);
        }
        else if(item.isToday())
        {
            ...
            holder.tvWeekDay.setBackgroundDrawable(getDateTodayBackground(holder.itemView));
            holder.tvWeekDay.setTextColor(mTodayDateTextColor);
        }
        else
        {
            holder.tvDay.setBackgroundColor(mBackgroundColor);
            holder.tvDay.setTextColor(mUnselectedDayTextColor);
            holder.tvWeekDay.setBackgroundColor(mBackgroundColor);
            holder.tvWeekDay.setTextColor(mUnselectedDayTextColor);
        }
    }

    private Drawable getDaySelectedBackground(View view) {
        Drawable drawable = view.getResources().getDrawable(R.drawable.calendar_yellow_day_number);
        //DrawableCompat.setTint(drawable,mDateSelectedColor);
        return drawable;
    }

    private Drawable getDateSelectedBackground(View view) {
        Drawable drawable = view.getResources().getDrawable(R.drawable.calendar_yellow_day_name);
        //DrawableCompat.setTint(drawable,mDateSelectedColor);
        return drawable;
    }

    private Drawable getDayTodayBackground(View view) {
        Drawable drawable = view.getResources().getDrawable(R.drawable.calendar_gray_day_number);
        return drawable;
    }

    private Drawable getDateTodayBackground(View view) {
        Drawable drawable = view.getResources().getDrawable(R.drawable.calendar_gray_day_name);
        return drawable;
    }
